...
const menuSections: MenuEntry[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Chai $60 / $70" },
      { name: "Soda Italiana $40 / $50", image: "/menu/soda-italiana-manzana-verde.jpeg" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Tizana Frappé $60 / $70", image: "/menu/tizana-frappe.jpeg" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Maracuyá $50 / $60", image: "/menu/smoothie-maracuya.jpeg" },
    ],
  },
  {
    type: "category",
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Mango $50 / $60", image: "/menu/chamoyada-mango.jpeg" },
