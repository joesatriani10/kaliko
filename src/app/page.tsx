...
const menuSections: MenuEntry[] = [
  ...
  },
  {
    ...
    note: "12oz o 16oz",
    items: [
      { name: "Chocolate $50 / $60", image: "/menu/chocolate.png" },
      { name: "Chocolate Con Bombón $55 / $65" },
      { name: "Chai (Clásico, Vainilla) $50 / $60" },
      { name: "Matcha $50 / $60", image: "/menu/matcha.png" },
  ...
  },
  {
    ...
    note: "12oz o 16oz",
    items: [
      { name: "Americano $40 / $50", image: "/menu/iced-americano.png" },
      { name: "Mocaccino $65 / $75" },
      { name: "Iced Latte $60 / $70", image: "/menu/iced-latte-real.png" },
  ...
  },
  {
    ...
    note: "12oz o 16oz",
    items: [
      { name: "Chocolate $60 / $70", image: "/menu/chocolate.png" },
      { name: "Matcha $60 / $70" },
      { name: "Matcha Strawberry $70 / $80", image: "/menu/matcha-strawberry.png" },
      { name: "Matcha Ceremonial $70 / $80" },
      { name: "Chai $60 / $70" },
      { name: "Soda Italiana $40 / $50", image: "/menu/soda-italiana-manzana-verde.png" },
  ...
  },
  {
    ...
    items: [
      { name: "Carajillo $70", image: "/menu/carajillo.png" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Tizana Frappé $60 / $70", image: "/menu/tizana-frappe.png" },
      { name: "Mazapan $60 / $70", image: "/menu/mazapan-real.png" },
      { name: "Flan $60 / $70", image: "/menu/flan-real.png" },
  ...
  },
  {
    ...
    note: "12oz o 16oz",
    items: [
      { name: "Zarzamora $50 / $60", image: "/menu/zarzamora-real.png" },
      { name: "Frutos Rojos $50 / $60", image: "/menu/frutos-rojos.png" },
      { name: "Fruta Del Dragón $50 / $60", image: "/menu/fruta-del-dragon-real.png" },
      { name: "Maracuyá $50 / $60", image: "/menu/smoothie-maracuya.png" },
    ],
  },
  {
    type: "category",
  ...
  },
  {
    ...
    note: "12oz o 16oz",
    items: [
      { name: "Sandia $50 / $60", image: "/menu/sandia-real.png" },
      { name: "Mango $50 / $60", image: "/menu/chamoyada-mango.png" },
      { name: "Tamarindo $50 / $60", image: "/menu/tamarindo-real.png" },
      { name: "Maracuyá $50 / $60", image: "/menu/smoothie-maracuya.png" },
      { name: "Frutos Tropicales $50 / $60", image: "/menu/frutos-tropicales-real.png" },
    ],
  },
  {
    type: "section",
